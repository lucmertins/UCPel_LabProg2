...
public class DepartamentoController {
    ...
    private void salvar() throws ServletException, IOException {
        ...
        try {
            ...
            ServletPrincipal5.dispatcherErro(req, resp, String.format("Não foi possível inserir departamento.[%s]", ex.getMessage()));
            return;
        }
    }
    ...
    private void carregar() throws ServletException, IOException {
        ...
        try {
            ...
            ServletPrincipal5.dispatcherErro(req, resp, String.format("Não foi possível ler departamento.[%s]", ex.getMessage()));
            return;
        }
    ...
    private void excluir() throws ServletException, IOException {
        ...
        try {
            ...
            ServletPrincipal5.dispatcherErro(req, resp, String.format("Não foi possível excluir departamento.[%s]", ex.getMessage()));
            return;
        }
    }
